...
export default function PublicProfile() {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: `${profile?.displayName || 'Professional'} - Digital Business Card`,
          text: `Check out ${profile?.displayName || 'this professional'}'s digital business card`,
          url: url
        });
      } catch (error) {
  ...
  if (profileLoading) {
    return (
      <div className="max-w-md mx-auto min-h-screen bg-card" data-testid="loading-profile">
  ...
  if (error || !profile) {
    return (
      <div className="max-w-md mx-auto min-h-screen bg-card flex items-center justify-center p-6" data-testid="profile-not-found">
  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-card" data-testid="public-profile">
      {/* Profile Header */}
      <div className="relative">
